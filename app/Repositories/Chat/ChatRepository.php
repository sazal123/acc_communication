...
class ChatRepository implements ChatContract{
    ...
    public function addUserToChat($payload){
        ...
        try {
            if(!empty($payload)) {
                $this->response = $this->chatSource->addUserToChatChat($payload);
            }
            DB::commit();
        } catch (Exception $e) {
            DB::rollBack();
    ...
    public function removeUserFromChat($payload){
        ...
        try {
            if(!empty($payload)) {
                $this->response = $this->chatSource->removeUserFromChat($payload);
            }
            DB::commit();
        } catch (Exception $e) {
            DB::rollBack();
    ...
    public function leaveFromChat($payload){
        ...
        try {
            if(!empty($payload)) {
                $this->response = $this->chatSource->leaveFromChat($payload);
            }
            DB::commit();
        } catch (Exception $e) {
            DB::rollBack();
